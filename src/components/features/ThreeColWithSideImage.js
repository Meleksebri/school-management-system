...
export default ({
  ...
  const defaultCards = [
    ...
    },
    {
      ...
      description:
        "Skooly is free school software that is always online, you can access it from anywhere, anytime. We will take care of your data and backups.",
    },
    {
      imageSrc: SimpleIconImage,
      title: "Absolutely Free",
      description:
        "Skooly is an absolutely 100% free school management software for a lifetime with no limitations. No need to buy anything. Just Sign Up",
    },
  ];
