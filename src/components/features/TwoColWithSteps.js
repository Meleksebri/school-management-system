...
export default ({
  ...
  const defaultSteps = [
    ...
    },
    {
      heading: "Wait",
      description:
        "Your inforamtion will be checked by the admin and you will get approved as soon as possible.",
    },
    {
      heading: "Use",
      description: "Now you can use Skooly Platform easily whenever you want.",
    },
  ];
